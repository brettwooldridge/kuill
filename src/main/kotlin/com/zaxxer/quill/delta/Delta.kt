...
import com.zaxxer.quill.delta.utils.DiffPatchMatch
 ...
 */
class Delta(var ops : MutableList<Op> = ArrayList())  {
    ...
    constructor(delta: Delta) : this(delta.ops)
    ...
    fun diff(other: Delta): Delta {
        ...
        val thisIter = Op.Iterator(this.ops)
        val otherIter = Op.Iterator(other.ops)
        val diffResult = DiffPatchMatch().diff_main(stringBuilder1.toString(), stringBuilder2.toString())
        val delta = Delta()
