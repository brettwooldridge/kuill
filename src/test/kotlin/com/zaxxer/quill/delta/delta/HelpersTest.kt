package com.zaxxer.quill.delta.delta
...
import com.zaxxer.quill.delta.Op
import com.zaxxer.quill.delta.OpAttributes
...
class HelpersTest {
    ...
    fun concatUnmergeable() {
        val delta = Delta().insert("Test")
        val original = DeltaJson.fromJson(DeltaJson.toJson(delta))
